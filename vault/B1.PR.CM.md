...
![](/assets/images/PR.CM.Poly-36.png) <!--ADDNOTES-->
...
![](/assets/images/PR.CM.PolyV2-38.png) <!--ADDNOTES-->
...
![](/assets/images/PR.CM.PolyV2-39.png) <!--ADDNOTES-->
...
![](/assets/images/PR.CM.PolyV2-40.png) <!--ADDNOTES-->
...
![](/assets/images/PR.CM.PolyV2-41.png) <!--ADDNOTES-->

> MNT : Modèle Numérique de Terrain aussi appelé $2.5D$

#### Voxels & Octrees

![](/assets/images/PR.CM.PolyV2-42.png) <!--ADDNOTES-->
...
![](/assets/images/PR.CM.PolyV2-43.png) <!--ADDNOTES-->

![](/assets/images/PR.CM.PolyV2-43-BB1.png)
![](/assets/images/PR.CM.PolyV2-43-BB2.png)

![](/assets/images/PR.CM.PolyV2-44.png) <!--ADDNOTES-->
![](/assets/images/PR.CM.PolyV2-45.png) <!--ADDNOTES-->
